...
import { parseAddress } from "@ximingwang/helpers";
const { AGGRON4 } = predefined;

// from https://github.com/@ximingwang/rfcs/blob/v2020.01.15/rfcs/0021-ckb-address-format/0021-ckb-address-format.md
const multiInfo = {
  R: 1,
  M: 2,
  publicKeyHashes: [
